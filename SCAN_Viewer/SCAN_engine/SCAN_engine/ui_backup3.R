                ...
                tabItem("maps_and_Cs",
                        ...
                        fluidRow(
                            ...
                            box(
                                ...
                                conditionalPanel( condition = "input.calculateCs == 'Cs_upload_csv' ", 
                                                  fileInput( inputId = "Cs_table", label = " select a .csv file with the Cs table", accept = c("text/csv","text/comma-separated-values,text/plain",".csv" ))
                                ), 
                                ...
                                fluidRow(
                                    ...
                                    box(tableOutput("Cs_head")),
                                    
                                    box(tableOutput("Cs_tail"))
